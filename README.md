...
![YOLOv8 Architecture](https://www.researchgate.net/publication/385510373/figure/fig3/AS:11431281288386137@1730689404423/Detailed-architecture-of-YOLOv8-showcasing-the-backbone-networks-multiple-convolutional.ppm)
...
> **Note**: The architecture image at the top of this README shows the detailed YOLOv8 structure with all components.

*YOLOv8 architecture: Backbone (CSPDarknet) → Neck (FPN + PAN) → Head (Anchor-Free Decoupled)*

### Actual YOLOv8s Layer Structure (from training)

This is the exact architecture used in our model (YOLOv8s with 11.1M parameters):
